...
*     ret - 是否成功提交.
*/
database.prototype.transaction = function (isolationLevel, taskCB, commitCB, rollbackCB) {
  return this.adapter.transaction(this, isolationLevel, taskCB, commitCB, rollbackCB);
}
