...
module.exports = class {
  ...
  */
  equal( key, value, alias = null ) {
    ...
    return ` ${alias?alias+'.':''}${t.map}=${this.adapter.type_cast(value, t.type)} `;
  }
  ...
  */
  between( key, value1, value2, alias = null ) {
    ...
    return ` ${alias?alias+'.':''}${t.map} BETWEEN ${this.adapter.type_cast(value1, t.type)} AND ${this.adapter.type_cast(value2, t.type)} `;
  }
