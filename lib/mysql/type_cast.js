...
const numberCast = function (value, c_type, c_unsigned, colName) {
  //
...
module.exports = (value, type, colName=null) => {
  ...
  switch (typeof value) {
    case 'string': {
      let rr = numberCast(value, c_type, c_unsigned, colName);
      if (rr) {
        return rr;
      }
